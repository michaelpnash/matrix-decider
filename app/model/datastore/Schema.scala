...
object Schema {
  ...
  object Criteria extends Table[CriteriaDTO]("CRITERIA") {
    ...
    def decisionId = column[String]("DECISION_ID")
    def id = column[String]("ID", O.PrimaryKey)
  ...
  case class AlternativeDTO(name: String, decisionId: String, id: String)
  ...
  case class RankingDTO(criteriaId: String, alternativeId: String, rank: Int)

  object Rankings extends Table[RankingDTO]("RANKINGS") {
    def criteriaId = column[String]("CRITERIA_ID")
    def alternativeId = column[String]("ALTERNATIVE_ID")
